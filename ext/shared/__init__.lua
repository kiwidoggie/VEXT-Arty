...
Events:Subscribe('Partition:Loaded', function(partition)
    ...
    -- Make changes...
    print("blastDamage: " .. artyExplosionData.blastDamage .. " blastRadius: " .. artyExplosionData.blastRadius .. " hasStunEffect: " .. tostring(artyExplosionData.hasStunEffect))
    artyExplosionData.blastDamage = 200.0
    artyExplosionData.blastRadius = 10.0
